...
rsync -au /stable-diffusion/ /workspace/stable-diffusion/
...
if [[ ! -L /workspace/stable-diffusion/models/Stable-diffusion/sd_xl_refiner_1.0.safetensors ]]; then
    ln -s /MODELS/sd_xl_refiner_1.0.safetensors /workspace/stable-diffusion/models/Stable-diffusion/sd_xl_refiner_1.0.safetensors
fi
