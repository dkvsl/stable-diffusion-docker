...
### Version 3.9.1 with SDXL support and ControlNet SDXL support
...
* [Automatic1111 Stable Diffusion Web UI](
  https://github.com/AUTOMATIC1111/stable-diffusion.git) 1.7.0
...
|--------------------|----------------------------------------------|----------|
| JUPYTER_PASSWORD   | Password for Jupyter Lab                     | Jup1t3! |
...
(**/workspace/stable-diffusion**) to manage the
...
the **/workspace/stable-diffusion/webui.sh -f**
script again.
